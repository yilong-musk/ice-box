...
const zh = {
  ...
  "home.copyCliProxy": "复制终端代理命令",
  "home.copyCliProxyCopied": "已复制",
  "home.copyCliProxyHint": "仅当前终端会话生效，不改全局环境",
...
const en: Record<MessageKey, string> = {
  ...
  "home.copyCliProxy": "Copy terminal proxy command",
  "home.copyCliProxyCopied": "Copied",
  "home.copyCliProxyHint": "This terminal session only; no global env change",
