...
const zh = {
  ...
  "home.memory.tooltip": "内核 {core} · 应用 {app}",
  "home.memory.tooltipAppOnly": "应用 {app} · 内核未运行",
  "home.memory.tooltipUnreadable": "应用 {app} · 不含内核（不可读）",
  ...
  "home.copyCliProxy": "复制代理命令",
  "home.copyCliProxyCopied": "已复制",
  "home.copyCliProxyHint": "复制会话级代理命令，仅当前终端生效",
  "home.openCliProxy": "打开代理终端",
  "home.openCliProxyHint": "打开带代理环境的默认终端，仅该窗口生效",
  ...
  "subs.hasDns": "DNS",
  "subs.trafficUsedTotal": "{used}/{total}（{percent}%）",
  "subs.trafficUsed": "已用 {used}",
  "subs.trafficRemaining": "剩余 {remaining}",
  "subs.trafficTotal": "总量 {total}",
  "subs.trafficExpire": "到期 {date}",
  "subs.trafficExpired": "已过期 {date}",
  ...
  "settings.appearanceDesc": "主题与语言默认跟随系统。",
  "settings.theme": "主题",
  ...
  "parse.groupRestrictedUrl": "策略组 {name}：健康检查 URL 不允许：{url}",
  ...
  "parse.routeRuleSetMissing": "路由规则引用了不可用的 rule_set {rule_set}，已跳过",
...
const en: Record<MessageKey, string> = {
  ...
  "home.memory.tooltip": "Core {core} · App {app}",
  "home.memory.tooltipAppOnly": "App {app} · core not running",
  "home.memory.tooltipUnreadable": "App {app} · core not included (unreadable)",
  "home.outboundTyped": "{tag} ({type})",
  "home.outboundGroupNow": "{tag} → {now}",
  ...
  "home.copyCliProxy": "Copy Proxy Command",
  "home.copyCliProxyCopied": "Copied",
  "home.copyCliProxyHint": "Copy a session-only proxy command",
  "home.openCliProxy": "Open Proxy Terminal",
  "home.openCliProxyHint": "Open the default terminal with proxy env (this window only)",
  ...
  "subs.hasDns": "DNS",
  "subs.trafficUsedTotal": "{used}/{total} ({percent}%)",
  "subs.trafficUsed": "Used {used}",
  "subs.trafficRemaining": "{remaining} left",
  "subs.trafficTotal": "Total {total}",
  "subs.trafficExpire": "Expires {date}",
  "subs.trafficExpired": "Expired {date}",
  ...
  "settings.appearanceDesc": "Theme and language follow the system by default.",
  ...
  "parse.groupRestrictedUrl": "Group {name}: health-check URL is not allowed: {url}",
  ...
  "parse.routeRuleSetMissing": "Route rule references unavailable rule_set {rule_set}; skipped",
